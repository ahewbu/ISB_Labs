...
def get_arguments(args: argparse.Namespace, path_to_settings: str) -> str | Any:
    """Function for obtaining a set of arguments required for programme execution
    Args:
    ...
    Returns:
        data required for programme execution
    """
